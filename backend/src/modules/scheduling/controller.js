...
const allowedItems = [
  {
    ...
    allow: true,
    policy: { baseFee: 15, feePerExtraItem: 5, includedWeightKgPerItem: 7, ratePerKg: 5 },
  },
  {
    id: 'e-waste',
    ...
    allow: true,
    policy: { baseFee: 12, feePerAdditionalItem: 5, includedWeightKgPerItem: 7, ratePerKg: 5 },
  },
  {
    id: 'yard',
    ...
    allow: true,
    policy: { baseFee: 8, feePerExtraItem: 3, includedWeightKgPerItem: 7, ratePerKg: 5 },
  },
  {
    id: 'wet-waste',
    ...
    allow: true,
    policy: { baseFee: 5, feePerExtraItem: 2, includedWeightKgPerItem: 7, ratePerKg: 5 },
  },
  {
    id: 'dry-recyclable',
  ...
  },
  {
    ...
    allow: true,
    policy: { baseFee: 10, feePerExtraItem: 4, includedWeightKgPerItem: 7, ratePerKg: 5 },
  },
  {
    id: 'construction',
